...
using Projeto_SalesWebMVC.Models.Enums;

namespace Projeto_SalesWebMVC.Data
{
    public class SeedingService
    {
        private Projeto_SalesWebMVCContext _context { get; set; }

        public SeedingService(Projeto_SalesWebMVCContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            _context.SalesRecords.AddRange(r1, r2, r3, r4, r5, r5, r7, r8, r9, 
